...
command: """
  ...
  declare -a domains=(
    ...
    europe-west3-gce.cloudharmony.net
...
settings:
  canvas_w: 150 # width and
  canvas_h: 20 # height of canvas for each graph in px
  default_max_ms: 50 # graph scale when ping is low
  bar_width: 4 # width in px of single bar on graph
